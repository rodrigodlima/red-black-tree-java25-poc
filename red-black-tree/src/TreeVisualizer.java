        ...
        try {
            ...
            new Thread(() -> {
                try {
                    ...
                    // Aplica fixInsert e mostra resultado final
                    if (newNode != null) {
    ...
    class TreePanel extends JPanel {
        ...
        private void drawNode(Graphics2D g, Node node, int x, int y, int offset) {
            ...
            if (node == highlightedNode) {
                // Nó sendo visitado durante a travessia — amarelo
                ...
                fillColor = new java.awt.Color(180, 40, 40);
                borderColor = new java.awt.Color(220, 80, 80);
            } else {
                fillColor = new java.awt.Color(40, 50, 70);
                borderColor = new java.awt.Color(90, 110, 150);
            }
